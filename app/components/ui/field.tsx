...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-sm leading-normal font-normal text-muted-foreground group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5 ml-3",
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-sm font-normal text-destructive ml-3", className)}
      {...props}
    >
      {content}
    </div>
